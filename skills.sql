...
-- left joins and inner joins.
    -- The different between left and inner joins is that while they both join
    -- tables, a left join also includes the items in the table on the left
    -- that fill the criteria but do not share the criteria to be 
    -- including in an inner join.

-- 3. Modify the query so that it only selects brands that 
-- don't have any models in the models table. 
